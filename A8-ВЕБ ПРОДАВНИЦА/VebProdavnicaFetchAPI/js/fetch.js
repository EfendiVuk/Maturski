...
//dodavanje eventa na taster trazi
pretragaTaster = document.getElementById('itrazi');

pretragaTaster.addEventListener('click',getData);
...
function getData() {
    ...
    var myRequest = new Request('./datoteka/vebprodavnica.txt');
